...
struct VertexOutput {
	...
	@location(5) surface_depth: f32,  // Depth of interpolated surface position
}
...
fn vs_main(in: VertexInput) -> VertexOutput {
	...
	out.view_depth = out.position.z / out.position.w;  // Interior depth (normalized)
	out.surface_depth = surface_clip.z / surface_clip.w;  // Surface depth for frag_depth
